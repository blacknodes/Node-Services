...
```
wget https://raw.githubusercontent.com/blacknodes/Node-Services/main/Projects/persistenceCore/PersistenceCore-Node-Monitoring/install-monitoring-tools.sh
```
...
# Add Job "persistenceCore-Node" in prometheus file 
```
sed -i '/scrape_configs:/a \
  - job_name: "persistenceCore-Node"\
    static_configs:\
...
```
sudo systemctl restart persistenceCored.service
...
https://raw.githubusercontent.com/blacknodes/Node-Services/main/Projects/persistenceCore/PersistenceCore-Node-Monitoring/PersistenceCoreDashboardByBlackNodes.json
