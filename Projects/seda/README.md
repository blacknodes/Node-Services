...
```
wget https://raw.githubusercontent.com/blacknodes/Node-Services/main/Projects/seda/Seda-Node-Monitoring/install-monitoring-tools.sh
```
...
# Add Job "seda-Node" in prometheus file 
```
...
```
sudo systemctl restart sedad.service
...
https://raw.githubusercontent.com/blacknodes/Node-Services/main/Projects/seda/Seda-Node-Monitoring/SedaDashboardByBlackNodes.json
